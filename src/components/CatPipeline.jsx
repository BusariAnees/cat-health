...
const data = [
  { name: "LOY-002", steps: [true, true, false], year: "2026" },
  { name: "LOY-001", steps: [true, false, false], year: "2027" },
  { name: "LOY-003", steps: [true, false, false], year: "2027" },
];
...
export default function CatPipeline() {
  return (
    <div className="bg-[#f8f7f2] pt-18 pb-12 px-40 font-sans">
      ...
      <div className="border-t border-gray-300 ">
        ...
        {data.map((item, idx) => (
          <div
            className="grid grid-cols-[100px_repeat(4,0.5fr)_60px] items-center mb-4 "
            key={idx}
          >
  ...
  <div className="w-4 h-4 rounded-full !border-[1.3px] !border-[rgb(104,163,202)] flex items-center justify-center">
    <div className="w-[0.45rem] h-[0.45rem] bg-[rgb(104,163,202)] rounded-full"></div>
            ...
            <div className="text-center text-sm bg-none !border-[rgb(213,212,174)]  px-2 py-1 rounded-full !border">
              {item.year}*
            </div>
          </div>
        ))}
